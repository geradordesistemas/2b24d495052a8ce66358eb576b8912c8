...
./run.sh bin/console security:create-admin AlanGuedes alanguedes00@live.com 2b24d495052a8ce66358eb576b8912c8

# Cria usuário padrão
./run.sh bin/console security:create-user AlanGuedes alanguedes00@live.com 2b24d495052a8ce66358eb576b8912c8
